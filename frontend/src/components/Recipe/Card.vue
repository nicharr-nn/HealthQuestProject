  ...
  >
    ...
    >
      <div class="p-2 sm:p-4 text-center w-full">
        <h3 class="text-base sm:text-lg lg:text-xl font-bold break-words uppercase">
        ...
        <div class="flex items-center justify-center gap-2 mt-2">
          <div class="flex gap-1">
            <Star
              ...
              :key="star"
              class="w-5 h-5"
              :class="star <= Math.round(recipe.average_rating || 0) ? 'text-yellow-400 fill-current' : 'text-gray-300'"
            />
          </div>
    ...
    >
      ...
      <div class="flex-1 p-4 sm:p-6 lg:p-8">
        <div class="h-full overflow-y-auto">
          <h4 class="text-sm sm:text-base lg:text-lg font-bold mb-2">
            <cooking-pot class="inline w-4 h-4 mr-1 text-[#846757] fill-current -mt-1" /> INGREDIENTS
          </h4>
          ...
          <h4 class="text-sm sm:text-base lg:text-lg font-bold mb-2">
            <list class="inline w-4 h-4 mr-1 text-[#846757] -mt-1" /> STEPS
          </h4>
      ...
      <div class="flex lg:flex-col lg:w-[10%] w-full">
        ...
        <div class="relative flex-1 lg:h-full group">
          <a
            ...
            download
          >
           <Save class="w-6 h-6 text-gray-600 group-hover:text-gray-700 transition-colors" />
        </a>
        ...
        <button
          ...
          class="bg-pink-200 hover:bg-pink-300 text-[#846757] flex-1 lg:h-full lg:py-2 font-semibold cursor-pointer text-lg sm:text-xl flex items-center justify-center"
          title="Rate this recipe"
          >
          <Star 
            class="w-5 h-5" 
            :class="userRating > 0 ? 'text-[#846757] fill-current' : 'text-[#846757]'" 
          />
        </button>
        ...
        <template v-if="isMyRecipe">
          ...
          <button
            ...
            class="bg-yellow-200 hover:bg-yellow-300 text-[#846757] flex-1 lg:h-full lg:py-2 font-semibold cursor-pointer text-lg sm:text-xl flex items-center justify-center"
          >
          ...
          <button
            ...
            class="bg-red-300 hover:bg-red-400 text-[#846757] flex-1 lg:h-full lg:py-2 font-semibold rounded-br-xl cursor-pointer text-lg sm:text-xl justify-center flex items-center"
          >
