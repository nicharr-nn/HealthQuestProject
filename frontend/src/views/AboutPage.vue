<template>
  <div
    class="h-screen text-[#846757] font-bold pl-6 md:pl-10 bg-[#FAF4E6] flex flex-col items-center justify-center gap-6"
  >
    ...
    <button
      @click="logout"
      class="bg-[#E99D7D] hover:bg-orange-500 text-[#A75B3A] text-lg md:text-[20px] h-[50px] w-[200px] rounded-full border-2 border-[#A75B3A]"
    >
      Sign Out
    </button>
  </div>
