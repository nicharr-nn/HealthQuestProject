    ...
    <div class="max-w-6xl mx-auto">
      ...
      <div class="flex items-center justify-between mb-6">
        ...
        <div class="flex items-center gap-4">
          ...
          <!-- Complete All Button / Status -->
          <button 
            v-if="selectedDayInfo.type !== 'rest' && selectedDayInfo.workouts?.length > 0"
            @click="toggleAllWorkouts(selectedDay)"
            :class="[
          ...
          >
            <svg 
              v-if="allWorkoutsComplete(selectedDayInfo.workouts)"
              class="w-5 h-5" 
              fill="currentColor" 
              viewBox="0 0 20 20"
            >
            ...
            {{ allWorkoutsComplete(selectedDayInfo.workouts) ? 'Day Complete!' : 'Mark All Complete' }}
          </button>
            ...
            >
              ...
              <div class="p-6 flex items-start gap-6">
                ...
                <div class="flex flex-col gap-3 items-end">
                  ...
                  <button 
                    @click="toggleFavorite(selectedDay, index)"
                    class="p-2 hover:bg-gray-100 rounded-full transition-colors"
                  >
                    <svg 
                      :class="[
                        'w-6 h-6 transition-colors',
                        workout.favorite ? 'fill-red-500 text-red-500' : 'fill-none text-gray-400'
                      ]"
                      stroke="currentColor" 
                      viewBox="0 0 24 24"
                    >
