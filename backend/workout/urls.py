...
urlpatterns = [
    ...
    path("programs/<int:id>/", views.workout_program_detail, name="workout-program-detail"),
    ...
    path("analytics/weekly-activity/", views.user_weekly_activity, name="weekly-activity"),
    path("day/<int:id>/videos/", views.workout_day_videos, name="workout-day-videos"),
    path("day/<int:id>/complete/", views.complete_workout_day, name="complete-workout-day"),
